...
fantasiagenesis_subsystem_operation_dead = r"""
...
- topological transitions in grid/trade structures
- metastability and energy barriers in institutional landscapes
